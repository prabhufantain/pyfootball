...
from pyfootball_storagehandler import *
...
class RcaApp():
    ...
    def check_token_active(self):
        ...
        if expire_time and access_token:
            ...
            if not datetime.now() < datetime.fromtimestamp(float(expire_time)):
                ...
                expire_time = self.store_handler.get_value("expires")
                self.access_token = self.store_handler.get_value(
                    "access_token")
                logger.info('Access token noy expired yet')
        else:
            self.auth()
    ...
    def get_match(self, match_key, card_type="full_card"):
        ...
        match_url = "https://e6111797.ngrok.io/get_match"
        params = {}
    ...
    def get_season(self, season_key, card_type="micro_card"):
        ...
        season_url = 'https://e6111797.ngrok.io/get_season'
        params = {}
        params["card_type"] = card_type
    ...
    def get_tournament_matches(self, tour_key, round_key, card_type=""):
        ...
        season_url = 'https://e6111797.ngrok.io/get_tournament_rounds'
        params = {}
        params["card_type"] = card_type
        response = self.get_response(season_url, params)
        return response
    ...
    def get_recent_seasons(self):
        ...
        recent_seasons_url = 'https://e6111797.ngrok.io/get_recent_season/'
